            ...
            <Card.Body className="p-4">
              <div className="text-center mb-4">
                <div style={{ width: 56, height: 56, borderRadius: 14, background: '#2563EB', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
                  <span style={{ color: 'white', fontSize: 20, fontWeight: 700 }}>OJ</span>
                </div>
                <h4 className="mb-0">用户登录</h4>
                <p className="text-muted mt-1" style={{ fontSize: '0.85rem' }}>欢迎回到在线评测系统</p>
              </div>
